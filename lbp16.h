...
#define CMD_READ_AREA_INFO_ADDR16_INCR(space, size)   (CMD_READ_AREA_INFO_16 | LBP_ADDR_AUTO_INC | space | ((size) & 0x7F))

#define CMD_READ_HOSTMOT2_ADDR32(size)        (CMD_READ_ADDR_32 | LBP_SPACE_HM2 | ((size) & 0x7F))
#define CMD_READ_HOSTMOT2_ADDR32_INCR(size)   (CMD_READ_ADDR_32 | LBP_SPACE_HM2 | LBP_ADDR_AUTO_INC | ((size) & 0x7F))
#define CMD_READ_ETH_CHIP_ADDR16(size)        (CMD_READ_ADDR_16 | LBP_SPACE_ETH_CHIP | ((size) & 0x7F))
#define CMD_READ_ETH_CHIP_ADDR16_INCR(size)   (CMD_READ_ADDR_16 | LBP_SPACE_ETH_CHIP | LBP_ADDR_AUTO_INC | ((size) & 0x7F))
#define CMD_READ_ETH_EEPROM_ADDR16(size)      (CMD_READ_ADDR_16 | LBP_SPACE_ETH_EEPROM | ((size) & 0x7F))
#define CMD_READ_ETH_EEPROM_ADDR16_INCR(size) (CMD_READ_ADDR_16 | LBP_SPACE_ETH_EEPROM | LBP_ADDR_AUTO_INC | ((size) & 0x7F))
...
#define CMD_READ_COMM_CTRL_ADDR16_INCR(size)  (CMD_READ_ADDR_16 | LBP_SPACE_COMM_CTRL | LBP_ADDR_AUTO_INC | ((size) & 0x7F))
#define CMD_READ_BOARD_INFO_ADDR16(size)      (CMD_READ_ADDR_16 | LBP_SPACE_BOARD_INFO | ((size) & 0x7F))
#define CMD_READ_BOARD_INFO_ADDR16_INCR(size) (CMD_READ_ADDR_16 | LBP_SPACE_BOARD_INFO | LBP_ADDR_AUTO_INC | ((size) & 0x7F))
...
#define CMD_WRITE_ETH_EEPROM_ADDR16_INCR(size) (CMD_WRITE_ADDR_16_INCR | LBP_SPACE_ETH_EEPROM | ((size) & 0x7F))
