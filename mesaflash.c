...
void print_usage() {
    ...
    printf("                    the board power and do not reload board, and need to run\n");
    printf("                    restoring process again).\n");
    printf("  --sha256-check    Integrity check FPGA configuration file before writing.\n");
